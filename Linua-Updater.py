...
class LinuaUpdater(QMainWindow):
    ...
    def load_dlc_database(self):
        """Загрузка базы данных DLC - 103 шт"""
        db = {
            # Expansion Packs (20)
            ...
            "EP03": {"name": "City Living", "url": "https://c10.patreonusercontent.com/4/patreon-media/p/post/134569592/3fe411d511ce42b1919b3f5e17cd35f9/eyJhIjoxLCJwIjoxfQ%3D%3D/1.zip?token-hash=HD8lr9JdGcb1N3shQ5c9wluV5ZnLeWsI1l3ZXkTahxk%3D&token-time=1764720000"},
            ...
            "EP06": {"name": "Get Famous", "url": "https://c10.patreonusercontent.com/4/patreon-media/p/post/134569592/aaff9f8d0e6942ab97dc8c5a8f298729/eyJhIjoxLCJwIjoxfQ%3D%3D/1.zip?token-hash=vAKvhMmU8mZLTKoUg5vfzdzg2I_nAERcbu1y30xBrf0%3D&token-time=1764720000"},
